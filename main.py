...
async def send_photo(message: types.Message):
    ...
    # schedule parsing
    while True:
        schedule = pd.read_html("https://lyceum.tom.ru/raspsp/index.php?k=b10&s=1", keep_default_na=False, encoding="cp1251") # ptcp154, also work
        ...
        if last_edit != edit:
            ...
            schedule = schedule[4 + day_of_week % 5 - day_of_week // 5].iloc[:, 1:]
